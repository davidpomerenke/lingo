...
export function VoiceOrb({ isActive, isListening, isSpeaking, onClick, disabled }: VoiceOrbProps) {
  return (
    <button
      onClick={onClick}
      disabled={disabled}
    ...
    >
      ...
      <div
        className={cn(
          ...
          isListening
            ? "from-accent via-accent/80 to-primary scale-110 shadow-accent/30"
            : isSpeaking
            ? "from-primary via-primary/80 to-accent shadow-primary/30"
